...
//            val gradleCache = Bind(gradle, Volume("/home/skeleton/.gradle/caches/"))
     ...
     *
     * @param appId String is application id for which app needs to be generated
     * @param successCallbackUri is the callback URI to handle response on successful generation of apk
     * @param failureCallbackUri is the callback URI to handle APK generation failures
     * @param apkPrefix is the application prefix to be prepended to generated file before upload.
    ...
    suspend fun generateApp(
        ...
        apkPrefix: String, buildData: Map<String, String>, verify: (suspend () -> Boolean)? = null
    ) {
